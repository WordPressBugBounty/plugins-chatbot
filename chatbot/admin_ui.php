        ...
        <nav>
          <ul>
            ...
            <li tab-data="custom_css',  'wpbot' );  ?> "> <a href="<?php echo esc_url($action .'&tab=ai',  'wpbot' );  ?> "> 
              <span class="<?php esc_attr_e( 'wpwbot-admin-tab-icon',  'wpbot' );  ?> "> <i class="<?php esc_attr_e( 'fa fa-code',  'wpbot' );  ?> "></i> 
            </span> <span class="<?php esc_attr_e( 'wpwbot-admin-tab-name',  'wpbot' );  ?> "> <?php esc_html_e('Custom CSS', 'wpbot'); ?></span> 
          </a>
            </li>
        ...
        <section id="<?php  esc_attr_e( 'section-flip-9',  'wpbot' );  ?> "> 
          ...
          <h3><?php esc_html_e('Feature Highlights', 'wpbot'); ?></h3>
            ...
            <div class="qcld-seo-help-feature-left">
              ...
              <div class="qcld-seo-help-feature-right">
            <img style="width:100%" src="<?php echo esc_url( QCLD_wpCHATBOT_IMG_URL . '/conversational-form-chatbot.jpg' ); ?>" alt="conversational form">
            </div>
          </div>
        </section> 
        <section id="<?php  esc_attr_e( 'section-flip-11',  'wpbot' );  ?> "> 
          <div class="<?php esc_attr_e( 'cxsc-settings-blocks-addon',  'wpbot' );  ?> ">
