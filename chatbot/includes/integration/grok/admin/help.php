	...
	<div class="card">
		...
		<div id="panelsStayOpen-collapseZero-gemini" class="collapse show" aria-labelledby="panelsStayOpen-headingZero-gemini" data-parent="#qcldopenaiaccordion">
			<div class="card-body">
					...
					<?php esc_html_e( 'Please make sure that DialogFlow and OpenAI are disabled if you want Gemini to work.', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'Please go to the following link after logging in:', 'wpchatbot' ); ?></br>
					...
					<?php esc_html_e( 'Without credits the key exists but requests will fail.', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'Steps to Create a Collection (Easiest Way: via Web Console)
					...
					<?php esc_html_e( 'Make sure you have an API key already (if not, go to API Keys section → Create one, as covered before).', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'Navigate to the Collections tab/section:', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'It`s usually in the sidebar or main dashboard (look for "Collections", "Files", or "Knowledge Bases").', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'Direct path if available:', 'wpchatbot' ); ?></br> <a href="https://console.x.ai/collections" target="_blank"><?php esc_html_e( 'https://console.x.ai/collections', 'wpchatbot' ); ?></a><?php esc_html_e( '(or similar—check the menu after login).', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'Click Create Collection (or "New Collection" / "+ Create").', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'Fill in the details:', 'wpchatbot' ); ?></br>
				    <?php esc_html_e( 'Name: Give it a clear name (e.g., "Research Papers", "Company Docs", "Codebase 2026").', 'wpchatbot' ); ?></br>
					<?php esc_html_e( 'Description (optional): Brief note about what`s inside.', 'wpchatbot' ); ?></br>
