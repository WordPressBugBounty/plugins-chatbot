...
<div class="card-body p-sm-0">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#wp-chatbot-grok-settings"><?php echo esc_html__( 'Grok AI settings', 'wpchatbot' ); ?></a></li>
		<li><a data-toggle="tab" href="#wp-chatbot-grok-help"><?php echo esc_html__( 'Grok AI Help', 'wpchatbot' ); ?></a></li>
	</ul>
	...
	<div class="tab-content">
		<div id="wp-chatbot-grok-settings" class="tab-pane in active">
			<div class="row gx-0">
				<div class="mb-3">
					<div class="form-check form-switch my-4">
						...
						<?php esc_html_e( 'Enable Grok AI', 'wpchatbot' ); ?><span style="color:red"> <?php esc_html_e( '(if you want results from grok only, disable Site Search from Settings->Start Menu)', 'wpchatbot' ); ?></span>
						</label>
					</div>
				</div>
			</div>
			<div class="row gx-0">
				<div class="mb-3">
					<div class="form-check form-switch my-4">
						...
						<?php esc_html_e( 'Enable page suggestions with grok Result', 'wpchatbot' ); ?>
						</label>
					</div>
				<!-- POST TYPE -->
				<div class="form-check form-switch my-4">
			...
			<div class="row g-0"> 
				<div class="gx-0">
					<div class="form-group mb-3">
						<label for="qcld_grok_system_content"><?php esc_attr_e( 'System Command or Prompt for RAG and OpenAI Direct (Use it to Instruct ChatGPT how to behave)', 'wpchatbot' ); ?></label>
						...
						<label><small><?php esc_html_e( "To set the ChatBot's tone and character set a system message according to your need", 'wpchatbot' ); ?></small></label></br>
						<label><small><?php esc_html_e( 'Example: You are a helpful Assistant. Be concise and relevant in your answers and do not introduce new topic.', 'wpchatbot' ); ?></small></label>
					</div>
				</div>
				<div class="form-group mb-3">
					<a class="btn btn-success" id="qcld_save_grok_setting"><?php esc_html_e( 'Save settings', 'wpchatbot' ); ?></a>
				</div>
			</div>
		</div>
