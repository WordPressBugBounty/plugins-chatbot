...
/**
 * Class OpenRouter_Actions
 */
class OpenRouter_Actions extends Action {
	...
	public function __construct() {
		$this->id    = 'openrouter';
		$this->group = __( 'OpenRouter', 'wpbot-automator' );
	}
	...
	private function chat_completion( $config, $trigger_data ) {
		...
		$api_key     = isset( $config_values['api_key'] ) ? $this->parse_tokens( $config_values['api_key'], $trigger_data ) : '';
		$model       = isset( $config_values['model'] ) ? $config_values['model'] : 'openai/gpt-3.5-turbo';
